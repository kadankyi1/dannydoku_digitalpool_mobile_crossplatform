...
function downloadAudio(x){
  ...
  app.dialog.alert("Saving offline. Download may take a while. After down is complete, find the offline media at the Download Section. Click The Download Button Icon that appears after the clicking the button on right lower corner ", "Download");
  ...
  console.log("this_audio_path : " + this_audio_path);

  dl.Get(this_audio_path);
  
  function DownloaderError(err) {

      console.log("download error: " + this_audio_path);
      app.dialog.alert("Download Error. Please make sure you have enough space and the application has storage permission to save to your device", "Error");
  ...
  function DownloaderSuccess() {
      ...
      //console.log("yay!");
      app.dialog.alert("Download Successful.", "Download Success");
