...
// Dom7
var $$ = Dom7;
var CONFIG = "https://app.dannydoku.com/";
...
*/
    ...
    if(disUsername.trim() == "" || disPassword.trim() == "" ){
        ...
        //toastBottom.open_COMMENTEDOUT();
        app.dialog.alert("All Fields Must Be Completed", "Oops");
        ...
        app.request({
          ...
          //console.log(response);
              ...
              if(loginResponse["status"] == "yes"){
                ...
                toastError.open_COMMENTEDOUT();
                */

                app.dialog.alert(this_message, "Oops");

              }
            } else {
                var this_message = "Something went Awry. It's Not Your Fault. Try Again later";
                /*
                var toastError = app.toast.create({
                  text: this_message,
                  closeTimeout: 2000,
...
*/
    ...
    if(disSignupName.trim() == "" || disSignupEmail.trim() == "" || disSignupPassword.trim() != disSignupPasswordRepeat ){
      ...
      if(disSignupPassword.trim() != disSignupPasswordRepeat.trim()){
        ...
        //toastPasswordsDontMatch.open_COMMENTEDOUT();
        app.dialog.alert("Passwords do not match", "Oops");
                ...
                ///////////////////////////////////////////////////////////////
                        ...
                        if(i < total_news_num){
                            ...
                            var display_style = "none";
                                ...
                                if(this_poster_path.trim() == "" || this_poster_path.trim() == "https://app.dannydoku.com"){

                                      this_poster_path = "img/logo.png";

                                }
     
                                if(this_poster_path_2.trim() == "" || this_poster_path_2.trim() == "https://app.dannydoku.com"){
...
function addToDownloadedVideos(poster_path, video_path, video_title, video_date){
  ...
  if(favoriteVideosPathDownloads == null || favoriteVideosPosterPathDownloads == null){
      ...
      toastResponse.open_COMMENTEDOUT();
      */

      app.dialog.alert("Added to download videos", "Info");
      ...
      if(already_added == 0){
        ...
        /*
          ...
          toastResponse.open_COMMENTEDOUT();
        */
          app.dialog.alert("This video exits in downloads", "Info");
      }
...
function addToDownloadedAudios(poster_path, video_path, video_title, video_date){
  ...
  if(favoriteAudiosPathDownloads == null || favoriteAudiosPosterPathDownloads == null){
      ...
      toastResponse.open_COMMENTEDOUT();
      */
      app.dialog.alert("Added to download audios", "Info");
      ...
      if(already_added == 0){
        ...
        */
          ...
          app.dialog.alert("This audio is already part of your downloads", "Info");
      }
...
function downloadAudio(x){
  ...
  //url = "https://yourcompany.com/abc.apk";
...
function sendMessage() {
    ...
    */
    ...
    if(disMessageText.trim() == ""){
        ...
        app.dialog.alert("Your message cannot be empty", "Info");
        ...
        app.request({
          ...
          success: function(response){
              ...
              */
                ...
                app.dialog.alert(response, "Info");
          ...
          error: function(XMLHttpRequest, textStatus, errorThrown) {
                ...
                toastError.open_COMMENTEDOUT();
                */
                app.dialog.alert("Poor network connection. Try again later", "Oops");
              app.preloader.hide();
          }
        });
    } else {
...
function addToVideosFavorties(x){
  ...
  if(favoriteVideosPath == null || favoriteVideosPosterPath == null){
      ...
      /*
      var toastResponse = app.toast.create({
        text: "Added to favorite videos",
        closeTimeout: 2000,
      });
      toastResponse.open_COMMENTEDOUT();
      */
      app.dialog.alert("Added to favorite videos", "Info");
...
function addToAudiosFavorties(x){
  ...
  if(favoriteAudiosPath == null || favoriteAudiosPosterPath == null){
      ...
      */
      ...
      app.dialog.alert("Added to favorite audios", "Info");
      ...
      if(already_added == 0){
        ...
        /*
          ...
          toastResponse.open_COMMENTEDOUT();
        */
          app.dialog.alert("This audio is already part of your favorites", "Oops");
      }
  ...
  if(favoriteAudiosPath == null || favoriteAudiosPosterPath == null || 
    favoriteAudiostitle == null|| favoriteAudiosDate == null){
          ...
          */
          ...
          app.dialog.alert("No favorite audios", "Oops");
    ...
    for(j=0; j < Object.keys(favoriteAudiosPath).length; j++){
      ...
      if(this_path.trim() == remove_video_path.trim() || encodeURI(this_path) == remove_video_path.trim()){
        ...
        favoriteAudiosDate.splice(j, 1);
          ...
          toastResponse.open_COMMENTEDOUT();
          */
          app.dialog.alert("Removed from favorite audios", "Info");
  ...
  if(favoriteVideosPath == null || favoriteVideosPosterPath == null || 
    ...
    for(j=0; j < Object.keys(favoriteVideosPath).length; j++){
      ...
      if(this_path.trim() == remove_video_path.trim()){
        ...
        toastResponse.open_COMMENTEDOUT();
        */
        app.dialog.alert("Removed from favorite videos", "Info");
        x.style.color = "grey";
        break;
...
function setDownloadAudios(){
  ...
  if(favoriteAudiosPathDownloads == null || favoriteAudiosPosterPathDownloads == null || 
    favoriteAudiostitleDownloads == null|| favoriteAudiosDateDownloads == null){
          ...
          toastResponse.open_COMMENTEDOUT();
          */
        app.dialog.alert("You have no downloaded audio", "Oops");
...
function setDownloadVideos(){
  ...
  if(favoriteVideosPathDownloads == null || favoriteVideosPosterPathDownloads == null || 
    favoriteVideostitleDownloads == null|| favoriteVideosDateDownloads == null){
          ...
          toastResponse.open_COMMENTEDOUT();
          */
        app.dialog.alert("You have no downloaded videos", "Oops");
...
function setFavoriteVideos(){
  ...
  if(favoriteVideosPath == null || favoriteVideosPosterPath == null || 
    favoriteVideostitle == null|| favoriteVideosDate == null){
          ...
          toastResponse.open_COMMENTEDOUT();
          */
        //app.dialog.alert("You have no favorite videos", "Oops");
...
document.getElementById('progress-bar').addEventListener('click', function (e) {
  ...
  if(old_audio.trim() == audio_path.trim()){
      ...
      if(poster_path ==  null || poster_path == undefined || poster_path.trim() == ""  || poster_path.trim() == "https://app.dannydoku.com"){
        ...
        app.request({
          ...
          success: function(response){
              ...
              if(loginResponse["status"] == "yes"){
                ...
                console.log("reset_system_id : " + reset_system_id);
...
*/
    ...
    if(reset_system_id.trim() == ""){
        ...
        //toastBottom1.open_COMMENTEDOUT();
        app.dialog.alert("Insufficient reset information. Please restart the process to get a new reset code", "Oops");
        ...
        //toastBottom2.open_COMMENTEDOUT();
        app.dialog.alert("Passwords do not match", "Oops");
